...
# ─── 7단계: 권한 설정 ─────────────────────────────────────────────────
log "[7/9] 권한 설정..."
# 채널 주인: allow VIEW_CHANNEL(1024) + SEND_MESSAGES(2048) + MANAGE_MESSAGES(8192) + CREATE_PUBLIC_THREADS(34359738368) + CREATE_PRIVATE_THREADS(68719476736) + SEND_MESSAGES_IN_THREADS(274877906944) = 377957133312, deny MANAGE_CHANNELS(16)
PERM_PAYLOAD='{"allow":"377957133312","deny":"16","type":1}'
